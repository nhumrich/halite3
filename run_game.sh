...
./halite --replay-directory replays/ "python3 MyBot.pypy --name a" "python3 MyBot.pypy --name b" "python3 ../halite-old/MyBot.pypy --name o1" "python3 ../halite-old/MyBot.pypy --name o2"
#./halite --replay-directory replays/ "python3 MyBot.pypy --name a" "python3 MyBot.pypy --name b" "python3 MyBot.pypy --name o1" "python3 MyBot.pypy --name o2"
